          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-100/80 mt-1">Start a new project and begin collaborating</p>
              </div>
            </div>
            <button 
              onClick={onClose}
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-3 pt-4 border-t border-gray-700">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
                {loading ? (
                  <>
