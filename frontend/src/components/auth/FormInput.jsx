    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          value={value}
          onChange={onChange}
          className={`w-full px-4 py-3 ${showPasswordToggle ? 'pr-12' : ''} bg-gray-700/50 border rounded-lg text-white placeholder-gray-400 focus:outline-none transition-all ${
            error 
